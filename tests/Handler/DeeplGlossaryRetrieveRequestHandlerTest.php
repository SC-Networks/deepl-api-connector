...
class DeeplGlossaryRetrieveRequestHandlerTest extends TestCase
{
    private StreamFactoryInterface&MockObject $streamFactory;

    private GlossaryIdSubmission&MockObject $submission;

    private DeeplGlossaryRetrieveRequestHandler $subject;
    ...
    protected function setUp(): void
    {
        ...
        $this->subject = new DeeplGlossaryRetrieveRequestHandler(
            $this->streamFactory,
            $this->submission,
        );
    }
