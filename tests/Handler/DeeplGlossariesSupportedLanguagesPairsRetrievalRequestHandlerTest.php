...
class DeeplGlossariesSupportedLanguagesPairsRetrievalRequestHandlerTest extends TestCase
{
    private StreamFactoryInterface&MockObject $streamFactory;

    private DeeplGlossariesSupportedLanguagesPairsRetrievalRequestHandler $subject;

    protected function setUp(): void
    {
        $this->streamFactory = $this->createMock(StreamFactoryInterface::class);

        $this->subject = new DeeplGlossariesSupportedLanguagesPairsRetrievalRequestHandler(
            $this->streamFactory,
        );
    }
